    ...
    <div className="top-header">
      ...
      <div className="right-header">
        ...
        <div>
          ...
          <svg className="icon-header" fill="#fff" viewBox="0 0 32 32">
            <path d="M8 8h4v4h-4zM8 14h4v4h-4zM8 20h4v4h-4zM16 20h8v4h-8zM30 0h-28c-1.105 0-2 0.894-2 2v28c0 1.105 0.894 2 2 2h28c1.105 0 2-0.895 2-2v-28c0-1.105-0.895-2-2-2zM28 28h-24v-24h24v24zM16 14h8v4h-8zM16 8h8v4h-8z"></path>
          </svg>
          <svg className="icon-header" fill="#fff" viewBox="0 0 32 32">
